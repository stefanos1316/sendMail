...
def calc_eval_measures():
    ...
    precision, recall, fscore, support = precision_recall_fscore_support(true, pred, average='binary', pos_label='1')
...
def train_test_validate(model, X_tr, Y_tr, X_te, Y_te, sample_weights_train, sample_weights_test):
    ...
    history = model.fit(X_tr, Y_tr, batch_size=256, epochs=100, validation_split=0.2)
